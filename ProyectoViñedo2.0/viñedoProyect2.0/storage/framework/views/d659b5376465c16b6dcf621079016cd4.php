...
<head>
  ...
  <title>Login &mdash; Viñedo</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?php echo e(asset('backend/assets/img/viñedoLogo.png')); ?>" alt="logo" width="200" class="">
            </div>

            <div class="card card-success">
              <div class="card-header"><h4>Inicia Sesion Admin</h4></div>
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo e(route('login')); ?>" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" type="email" class="form-control" name="email" tabindex="1" required autofocus value="<?php echo e(old('email')); ?>" >
...
</body><?php /**PATH C:\xampp\htdocs\viñedoProyect\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>