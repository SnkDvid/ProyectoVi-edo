        ...
        <tbody>
            <?php $__currentLoopData = $ventas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <span class="badge badge-pill badge-primary">Nombre producto: <?php echo e($venta->catalogo->id_nombre_producto); ?></span><br>
                        <span class="badge badge-pill badge-primary">Categoria: <?php echo e($venta->catalogo->id_categoria); ?></span><br>
                        <span class="badge badge-pill badge-primary">Cantidad: <?php echo e($venta->id_cantidad); ?></span><br>
                        <span class="badge badge-pill badge-primary">Valor Total:  <?php echo e(number_format($venta->id_cantidad * $venta->id_valor_final, 0, ',','.')); ?></span><br>
                    </td>
                </tr>
...
<?php /**PATH C:\xampp\htdocs\viñedoProyect\resources\views/admin/views/reporteVentas.blade.php ENDPATH**/ ?>