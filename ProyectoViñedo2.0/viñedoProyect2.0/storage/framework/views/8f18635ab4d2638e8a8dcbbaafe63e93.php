...
<section class="section">
    ...
    <a href=" <?php echo e(route('admin.views.reporteVentas')); ?> "><button class="btn btn-danger mb-2">PDF 📈</button></a>
                            ...
                            <?php $__currentLoopData = $ventas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        <td colspan="13">
                                            <div class="cliente-header">
                                                ...
                                                <form action="<?php echo e(route('admin.ventas.cancelarTotalmente', $venta->cliente->id)); ?>" method="POST" class="d-inline-block">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <form action=" <?php echo e(route('admin.ventas.cancelar', $venta->id)); ?> " class="btn_inhabilitar" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viñedoProyect\resources\views/admin/views/estado.blade.php ENDPATH**/ ?>