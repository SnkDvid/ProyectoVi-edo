...
<body>
    ...
    <!--============================
        HEADER START
    ==============================-->
        <?php echo $__env->make('frontend.home.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--============================
        HEADER END
    ==============================-->
    ...
    <!--============================
        MAIN MENU START
    ==============================-->
        <?php echo $__env->make('frontend.home.layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--============================
        MOBILE MENU END
    ==============================-->
...
</html><?php /**PATH C:\xampp\htdocs\viñedoProyect\resources\views/frontend/home/layouts/master.blade.php ENDPATH**/ ?>