...
<body style="font-family: 'Arial', sans-serif; background-color: #f9f9f9; margin: 0; padding: 0;">
    <div style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        ...
        <p style="color: #7f8c8d; font-size: 16px; text-align: center;">
            Le informamos que el producto <strong>{{ $productoNombre }}</strong> ha sido quitado de la venta debido a su falta de disponibilidad o por otro motivo relacionado con el stock. Lamentamos cualquier inconveniente que esto pueda causarle. 
        ...
        <div style="background-color: #ecf0f1; padding: 10px; border-radius: 5px; margin-top: 10px;">
            ...
            <ul style="list-style: none; padding-left: 0;">
                <li style="margin-bottom: 8px; font-size: 14px;">
                    <strong>Nombre del Producto:</strong> {{ $productoNombre }}
                </li>
                <li style="margin-bottom: 8px; font-size: 14px;">
                    <strong>Categoría:</strong> {{ $categoria }}
                </li>
                <li style="margin-bottom: 8px; font-size: 14px;">
                    <strong>Precio:</strong> {{ number_format($precio, 0, ',', '.') }} COP
                </li>
            </ul>
        </div>
